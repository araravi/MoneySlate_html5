...
<div data-role="page">
	...
	<div data-role="navbar">
		<ul>
			<li><a href="all.php" data-icon="check" data-iconpos="bottom">Recommended</a></li>
			<li><a href="all1.php" data-icon="star" data-iconpos="bottom">Fastest</a></li>
			<li><a href="all2.php" data-icon="minus" data-iconpos="bottom"  class="ui-btn-active ui-state-persist">Cheapest</a></li>
		</ul>
	</div><!-- /navbar -->
</div><!-- /footer -->
</div><!-- /page -->
