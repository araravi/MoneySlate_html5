	...
	<head>
		...
		<script type="text/javascript">
			...
			//add additional marker 
				$('#map_canvas').gmap('addMarker', {'position': '1.294691,103.853821', 'animation': google.maps.Animation.DROP,  'icon': 'images/bus.png' }).click(function() { 

					$('#map_canvas').gmap('openInfoWindow', { 'content': 'Bus 133<br/><span style="color:red">Bus Arriving in 2 mins</span><br/><span style="color:green">Next bus in 9 mins</span>'}, this);
			...
			//add additional marker 
				$('#map_canvas').gmap('addMarker', {'position': '1.276067,103.854682', 'animation': google.maps.Animation.DROP,  'icon': 'images/bus.png' }).click(function() { 
					...
					$('#map_canvas').gmap('openInfoWindow', { 'content': 'Bus 400<br/><span style="color:red">Bus Arriving in 5 mins</span><br/><span style="color:green">Next bus in 9 mins</span>'}, this);
	...
	<body> 
		<div id="basic_map" data-role="page">
			...
			<div data-role="header">
				<h1>Map</h1>
				<a href="nocab1.php" data-ajax="false" data-icon="back">Back</a>
			</div>
