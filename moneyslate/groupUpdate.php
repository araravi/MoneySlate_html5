...
function liveSearch(){
	...
	$("#updateGroup").live('click',function(){
		...
		$.ajax({
		      type: "PUT",
		      url: 'http://ec2-107-20-87-250.compute-1.amazonaws.com/update_group.php',
		      data: groupData,
...
<div data-role="content">
	<div id = "groupSettingsContent">
			...
			<li>
				...
				<label for="people_in_group">People in the group:</label>
					<div id="peopleGroupList">
						<ul data-role="listview" id="group_update_members" data-role="listview" data-inset="true">
						</ul>	
					</div>
		...
		<div data-role="fieldcontain">
			<input type="search" id="groupUpdateSearch" placeholder="Search facebook friends"/>
