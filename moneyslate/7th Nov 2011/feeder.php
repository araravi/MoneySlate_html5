...
<head> 
	...
	<div data-role="page" id="feeds">
				<script>
				$( '#feeds' ).live( 'pageinit',function(event){
					var url = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/api/feeds";
					   ...
					   $.each(json.feeds, function(i,exp){
						if(exp.owe==1)
						{
							if(exp.seen==0)
							{
							element = element+'<li data-theme="e" style="text-align:center">'+ "You owe "+exp.first_name+" S$ "+exp.amount;
							element = element+'</li>';	
							}
							else
							{
