...
$('#reportPage').live( 'pageshow',function(event){
	...
	$.getJSON(url, function(json) {
	   ...
	   $.each(json.report, function(i,person){
		...
		element = element+'<li><a style="white-space:normal" href="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/reportdetails.php?mem_id=' + person.mem_fb_id + '&mem_name='+person.first_name+'"><div class="ui-grid-a"><div class="ui-block-a" style="width:20%">'+ image + '</div>';
...
$(this).bind("swipeleft", function(){
	...
	if(paySel==0)
		$.mobile.changePage( "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/userreport.php");
	else
		$.mobile.changePage( "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/reportdetails.php?mem_id="+paySel+"&mem_name="+payName);
	});	
