...
<script type="text/javascript">
    ...
    <div data-role="header" id = "homehead" data-position="inline">
		<h1>UOMe</h1>
		<a href="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/feeder.php" data-icon="alert" class="ui-btn-right" id="alex" data-rel="dialog" >Alerts</a>
	    <a href="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/settings.php" data-rel="dialog" data-icon="gear" class="ui-btn-left" id="settings">Settings</a>
    ...
    <div data-role="content" class="ui-body ui-body-a">
		<div id = "staticTiles" class="ui-grid-a">
			<a href="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/expense.php"><div id="tile1" class="ui-block-a"><div class="leftTile"><img src = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/icons/expense_new.png" style="max-width:100%;max-height:100%"/></div></div></a>
			<a href="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/payment.php"><div id="tile2" class="ui-block-b"><div class="rightTile"><img src = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/icons/payment_new.png" style="max-width:100%;max-height:100%"/></div></div></a>
		</div>
		<div id="tileDiff">
			<div id="reportTileDiff">	
				<a href = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/userreport.php" style =  "text-decoration:none">	
							...
							<div id = "metileElement">
								...
								<div class="ui-grid-a">
									<div class="ui-block-a">
										<img id="repImg" src = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/icons/repp.png" style="max-width:100%;max-height:100%"/>
									</div>
			...
			<div id="meTileDiff">
				<a href = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/me.php" style="text-decoration: none">
					<div id = "metile" class="tile">
						<div id = "reporttileElement">
							<!--<center><div><img src = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/icons/ewe.png"/></div></center>-->
							<div class="ui-grid-a">
								<div class="ui-block-a">
									<img id="meImg" src = "http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/icons/mee.png" style="max-width:100%;max-height:100%"/>
								</div>
								<div class="ui-block-b">
									<div id="expCont">
										<div>I spent</div>
