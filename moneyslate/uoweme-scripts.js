...
function setMe(){
	...
	var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/meetile.php?month="+month+"&year="+year;
	var amt;
	$.getJSON(url, function(json) {
			amt = json.amount;
...
function setReport(){
	...
	var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/reporttile";
	var needAmt;
	var oweAmt;
	var total;
	var needPercent;
...
function setCategories(){
        var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/getCategory";
	var optionList = "";
	$.getJSON(url, function(json) {
...
function addcategory(cat){
	var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/addCategory.php";
...
function liveSearch(){
		...
		var prevtag = "";
			$('#friendSearch').bind('change keyup',function (e) {
				...
				var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/fr/"+searchTag;
				console.log(url);
...
$( '#addExpensePage' ).live( 'pageinit',function(event){
	...
	$(this).bind("swiperight", function(){
		  $.mobile.changePage( "http://ec2-107-20-87-250.compute-1.amazonaws.com/app0.1/home.php");
	});
	...
	$("#submitExpense").bind('click',function(){	
		$.mobile.showPageLoadingMsg();
			...
			$.ajax({
			      type: "PUT",
			      url: 'http://ec2-107-20-87-250.compute-1.amazonaws.com/putExpense.php',
			      data: expenseData,
...
$('#reportPage').live( 'pageinit',function(event){
	function populateHeaders(need,owe){
        var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/report";
	$.getJSON(url, function(json) {
	   var element = '';
	   var oweTag;
	   var progressTag;
	   ...
	   $.each(json.report, function(i,person){
		...
		element = element+'<li><a style="white-space:normal" href="http://ec2-107-20-87-250.compute-1.amazonaws.com/app0.1/reportdetails.php?mem_id=' + person.mem_fb_id + '&mem_name='+person.first_name+'"><div class="ui-grid-a"><div class="ui-block-a" style="width:20%">'+ image + '</div>';
...
function setPayment(){
	var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/addPaymentlist";
...
$(this).bind("swipeleft", function(){
	...
	if(paySel==0)
		$.mobile.changePage( "http://ec2-107-20-87-250.compute-1.amazonaws.com/app0.1/userreport.php");
	else
		$.mobile.changePage( "http://ec2-107-20-87-250.compute-1.amazonaws.com/app0.1/reportdetails.php?mem_id="+paySel+"&mem_name="+payName);
	});	
...
$('#paySubmit').bind('click',function(){
	...
	if(navigator.onLine){
		...
		$.ajax({
			  type: "PUT",
			  url: 'http://ec2-107-20-87-250.compute-1.amazonaws.com/addPayment.php',
			  data: payData,
			  contentType: 'application/json', // format of request payload
			  dataType: 'json', // format of the response
			  success: function(msg) {
...
function populateMe(mon,yr){
   ...
   if(yr!="12")
   var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/getMee.php?sd="+yr+"-"+mon+"-1&ed="+yr+"-"+temp_mon+"-1";
   else
   var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/getMee.php?sd="+yr+"-"+mon+"-1&ed="+temp_year+"-1-1";
   console.log(url);
   $.getJSON(url, function(json) {
   var element = '';
   var colorTag;
...
function checkAlerts(){
	var url = "http://ec2-107-20-87-250.compute-1.amazonaws.com/feed_check.php";
	if(navigator.onLine){
		$.getJSON(url, function(json){
		msg=(json.msg)
		if(json.msg==true)
