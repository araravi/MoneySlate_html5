...
function liveSearch(){
	...
	$("#saveGroup").bind('click',function(){
		...
		$.ajax({
		      type: "PUT",
		      url: 'http://mymoneyslate.com/api/new_group.php',
		      data: groupData,
	...
	$( '#groupSettings' ).live( 'pageshow',function(event){
	...
	<div id = "groupSettingsContent">
		<div data-role="fieldcontain">
			<input type="search" id="groupfriendSearch" placeholder="Search facebook friends"/>
				<ul data-role="listview" id="friends_details_group" data-inset="true" data-theme="a">
			</ul>
		</div>
		<ul data-role="listview" data-theme="a" data-inset="true">
			...
			<li>
				...
				<label for="people_in_group">People in the group:</label>
					<div id="peopleGroupList" class="ui-body ui-body-b">
						<ul data-theme="b" data-role="listview" id="friends_details_tagged" data-role="listview" data-inset="true">
						</ul>	
					</div>
