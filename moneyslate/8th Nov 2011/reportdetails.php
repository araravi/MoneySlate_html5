...
<body>
	<div data-role="page" id="reportDetails" data-add-back-btn="true">
		<script>
			...
			var url = "http://mymoneyslate.com/api/report_det.php?owe=" + <?php echo $_GET['mem_id'];?>;
			   ...
			   if(need_count!=0){
				...
				translongitude = need.longt;
					if(translatitude==-1||translongitude==-1){
						...
						maptag='<a data-ajax="false" href = "http://mymoneyslate.com/app0.1/mapwork.php?lat='+translatitude+'&longt='+translongitude+'&mem_id='+<?php echo $_GET['mem_id'];?>+'&exp_name='+need.exp_name+'">Location</a>'; 
					}
			   ...
			   if(owe_count!=0){
				$.each(json.Owe_to, function(i,owe){
					...
					if(translatitude==-1||translongitude==-1){
						...
						maptag='<a data-ajax="false" href = "http://mymoneyslate.com/app0.1/mapwork.php?lat='+translatitude+'&longt='+translongitude+'&mem_id='+<?php echo $_GET['mem_id'];?>+'&exp_name='+owe.exp_name+'">Location</a>';
					}
		...
		<div data-role="header">
			<h1><?php if(isset($_GET["mem_name"])){echo $_GET["mem_name"];} else echo "Report Details";?></h1>
		</div>
		<div data-role="content" class="ui-body ui-body-a">
			<div id = "needs">
			<h2 style = "color:#3ed853"> I need to get</h2>
			<ul id = "needtransactions" class = "ui-listview" data-theme='a' data-role="listview" data-inset="true">			
			</ul>
			</div>
			<div id = "owes">
			<h2 style = "color:#f25959">I owe</h2>
			<ul id = "owetransactions" class = "ui-listview" data-theme='a' data-role="listview" data-inset="true">
			</ul>
			</div>	
		</div>
	</div>
