...
{   
	...
	{	
	$flagArray[]="http://ec2-46-137-231-62.ap-southeast-1.compute.amazonaws.com/api/report_det.php?id=".$id123."&owe=".$value."&pass=uoweme1.";
    //echo $flagArray[$flag]."    ";
	$flag++;
	}
	...
	$retArray['report'][$flag]['first_name']=$new->first_name;
